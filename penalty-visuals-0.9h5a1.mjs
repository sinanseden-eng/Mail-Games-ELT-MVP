import { REPLAY_TIMELINE } from "./shootout-physics-0.9h5a1.mjs";
...
export const PENALTY_VISUAL_ASSETS = Object.freeze({
  ...
  singleAngle: Object.freeze({
    ...
    strikerContact: "./assets/penalty-single-angle/striker-contact-0.9h5a1.png",
    ball: "./assets/penalty-single-angle/realistic-ball-0.9h4d.png",
    strikerFollow: "./assets/penalty-single-angle/striker-follow-0.9h5a1.png",
    keeperReady: "./assets/penalty-single-angle/keeper-ready-0.9h5a1.png",
    keeperHighLeft: "./assets/penalty-single-angle/keeper-dive-right-0.9h5a1.png",
    keeperHighRight: "./assets/penalty-single-angle/keeper-dive-left-0.9h5a1.png",
    keeperLowLeft: "./assets/penalty-single-angle/keeper-dive-right-0.9h5a1.png",
    keeperLowRight: "./assets/penalty-single-angle/keeper-dive-left-0.9h5a1.png"
  })
});
