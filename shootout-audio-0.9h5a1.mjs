...
export function cueProfile(event = {}) {
  ...
  switch (event.type) {
    ...
    case "replay-start":
      return [
        { kind: "noise", duration: 0.72, gain: 0.011, filter: 780 },
        { kind: "tone", frequency: 420, endFrequency: 360, duration: 0.16, gain: 0.014, wave: "sine", delay: 0.06 }
      ];
    case "anticipation":
      return [
        { kind: "noise", duration: 0.26, gain: 0.010, filter: 720 },
        { kind: "tone", frequency: 310, endFrequency: 270, duration: 0.12, gain: 0.012, wave: "sine" }
      ];
    case "keeper-takeoff":
      return [
        { kind: "noise", duration: 0.085, gain: 0.032, filter: 620 },
        { kind: "tone", frequency: high ? 118 : 102, endFrequency: 68, duration: 0.13, gain: 0.026, wave: "sine" }
      ];
    case "camera-cut":
    ...
    case "settle":
      if (outcome === "goal") {
        return [
          { kind: "noise", duration: 0.22, gain: 0.012, filter: high ? 1550 : 1180 },
          { kind: "tone", frequency: high ? 96 : 78, endFrequency: 58, duration: 0.19, gain: 0.014, wave: "sine" }
        ];
      }
      if (outcome === "save") {
        return [{ kind: "noise", duration: 0.16, gain: 0.012, filter: 520 }];
      }
      return [];
    case "result":
      if (outcome === "goal") {
