import { REPLAY_TIMELINE } from "./shootout-physics-0.9h5a.mjs";
import { netSagEnvelope, netSagProfile } from "./shootout-net.mjs?v=0.9.29";
...
export const SINGLE_ANGLE_KEEPER_MOVES = Object.freeze({
  // 0.9H5A keeps dive length in translation, not artificial sprite growth.
  "top-left": Object.freeze({ asset: "keeperHighLeft", x: 76, y: 304, width: 190, height: 94, rotation: -0.035, label: "HIGH LEFT" }),
  "top-centre": Object.freeze({ asset: "keeperReady", x: 211, y: 302, width: 78, height: 124, rotation: 0, label: "HIGH CENTRE" }),
  "top-right": Object.freeze({ asset: "keeperHighRight", x: 216, y: 306, width: 190, height: 94, rotation: 0.035, label: "HIGH RIGHT" }),
  "bottom-left": Object.freeze({ asset: "keeperLowLeft", x: 82, y: 406, width: 178, height: 84, rotation: -0.020, label: "LOW LEFT" }),
  "bottom-centre": Object.freeze({ asset: "keeperReady", x: 222, y: 382, width: 76, height: 104, rotation: 0, label: "LOW CENTRE", scaleX: 1.04, scaleY: 0.90 }),
  "bottom-right": Object.freeze({ asset: "keeperLowRight", x: 226, y: 406, width: 178, height: 84, rotation: 0.020, label: "LOW RIGHT" })
});
...
export function singleAngleStrikerState(replay = {}, progress = 0, final = false) {
  ...
  const contactWidth = lerp(66, 108, approachT);
  const contactHeight = lerp(76, 132, approachT);
  ...
  const followWidth = lerp(88, 84, recoveryT);
  const followHeight = lerp(154, 148, recoveryT);
...
export class PenaltyVisualPack {
  ...
  drawSingleAngleKeeper(ctx, state, time = 0, reducedMotion = false) {
    ...
    const start = { x: 275, y: 326, width: 60, height: 150 };
