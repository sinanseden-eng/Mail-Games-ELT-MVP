...
import {
  ...
  sampleBallWorld,
  sampleKeeperMotion
} from "./shootout-physics-0.9h5a1.mjs";
...
import {
  ...
  goalPocketWorld,
  projectGoalZone
} from "./shootout-net.mjs?v=0.9.30";
...
import {
  ...
  mapCameraPoint,
  penaltyCameraFrame
} from "./shootout-cinematics.mjs?v=0.9.30";

import {
  PenaltyVisualPack,
  BROADCAST_SELECTION_POINTS,
  penaltyActionImpactPointForViewer
} from "./penalty-visuals-0.9h5a1.mjs";
import {
  PENALTY_VIEWERS,
  ...
  perspectiveLabel
} from "./penalty-perspective.mjs?v=0.9.30";
...
export class ShootoutScene {
  ...
  spawnCelebration(outcome) {
    // 0.9H5A1 keeps the television frame clean. Crowd and result audio carry the
