...
test("0.9H4C pages load the calibrated broadcast chain", async () => {
  ...
  assert.match(turn, /(?:turn-0\.9h4(?:c|d)\.js|turn-0\.9h5(?:a)?\.js)/);
  assert.match(replay, /(?:replay-0\.9h4(?:c|d)\.js|replay-0\.9h5(?:a)?\.js)/);
  assert.match(demo, /(?:shootout-0\.9h4(?:c|d)\.js|shootout-0\.9h5(?:a)?\.js)/);
});
