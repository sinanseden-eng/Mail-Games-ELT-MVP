...
test("0.9H4B pages load uniquely named broadcast entry scripts", async () => {
  ...
  assert.match(turn, /(?:turn-0\.9h4b\.js|turn-0\.9h4c\.js|turn-0\.9h4d\.js|turn-0\.9h5(?:a1?)?\.js)/);
  assert.match(replay, /(?:replay-0\.9h4b\.js|replay-0\.9h4c\.js|replay-0\.9h4d\.js|replay-0\.9h5(?:a1?)?\.js)/);
  assert.match(shootout, /(?:shootout-0\.9h4b\.js|shootout-0\.9h4c\.js|shootout-0\.9h4d\.js|shootout-0\.9h5(?:a1?)?\.js)/);
